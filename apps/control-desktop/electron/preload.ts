...
const api = {
  ...
  cloud: {
    ...
    qianfanShops: (includeArchived?: boolean) => ipcRenderer.invoke('cloud:qianfanShops', { includeArchived }),
  ...
  terminal: {
    ...
    write: (projectId: string, data: string) => ipcRenderer.invoke('terminal:write', projectId, data),
