  ...
  const [
    ...
    prisma.project.count({
      ...
      where: {
        ...
        OR: [{ lastScannedAt: { not: null } }, { locationType: 'cloud', serverPath: { not: null } }],
    ...
    prisma.operationLog.findFirst({ where: { action: 'scan_upload' }, orderBy: { createdAt: 'desc' } }),
