...
export default function SecretsPage() {
  ...
  async function load() {
    const all = await api.secrets({
      includeArchived: showTest,
  ...
  return (
    <div>
      ...
      <p>
        四个店铺的千帆 Cookie 统一存在这里。千帆中转机器人会自动上传；前端只显示脱敏内容，不返回完整
        Cookie。
      </p>
      ...
      >
        ...
        <button className="btn btn-secondary" type="button" onClick={alignQianfan}>
          对齐千帆四店名称
        </button>
